...
export class InstructorController {
  ...
  @ApiOperation({
    summary: '강의를 공개(OPEN) 또는 임시저장(DRAFT)으로 변경합니다.',
  })
  @ApiParam({ name: 'courseId', type: Number })
  @SwaggerResponse(
    InstructorCourseResponse,
  ...
  setCourseStatus(
    ...
    return this.instructorService.setCourseStatus(
      courseId,
      instructorId,
      body.status,
    );
  ...
  updateChapter(
    ...
    return this.instructorService.updateChapter(
      courseId,
      chapterId,
      instructorId,
      data,
  ...
  deleteChapter(
    ...
    return this.instructorService.deleteChapter(
      courseId,
      chapterId,
      instructorId,
    );
